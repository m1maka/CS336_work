...
def run_swiglu(
    ...
    swiglu = SwiGLU(
        d_model, d_ff, device=w1_weight.device, dtype=w1_weight.dtype
    )
...
def run_rmsnorm(
    ...
    """
    rmsnorm = RMSNorm(
        d_model, eps=eps, device=weights.device, dtype=weights.dtype
    )
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.optimizer import cosine_learning_rate
